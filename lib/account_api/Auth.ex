defmodule Accounts.Auth do
    ...
    alias Accounts.Helpers.MapHelper
    
    @app_secret_key Application.get_env(:accounts, :app_secret_key)
    @jwt_validity Application.get_env(:accounts, :jwt_validity)
  ...
  def handle_call({:issue_token, claims}, _from, state) when is_map(claims) do
    # nice to have : check for valid token
